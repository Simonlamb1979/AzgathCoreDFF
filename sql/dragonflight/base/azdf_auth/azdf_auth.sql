...
MySQL - 10.5.8-MariaDB : Database - azdf_auth
*********************************************************************
*/
...
/*Data for the table `battle_pet_declinedname` */
...
/*Data for the table `battlenet_account_transmog_illusions` */
...
CREATE TABLE `logs_ip_actions` (
  ...
  `ip` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '127.0.0.1',
  `systemnote` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Notes inserted by system',
  `unixtime` int(10) unsigned NOT NULL COMMENT 'Unixtime',
  `time` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Timestamp',
  `comment` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Allows users to add a comment',
  PRIMARY KEY (`id`)
...
('$/sql/dragonflight/updates/auth','RELEASED');
...
(1,1671589153,0,0,'AzgathCore rev. e03248903752+ 2022-12-17 19:05:26 +0100 (main branch) (Win64, Release, Static)'),
(1,1671592948,0,0,'AzgathCore rev. e03248903752+ 2022-12-17 19:05:26 +0100 (main branch) (Win64, Release, Static)');
...
/*!50001 CREATE TABLE  `vw_log_history`(
 `First Logged` datetime /* mariadb-5.3 */ ,
 `Last Logged` datetime /* mariadb-5.3 */ ,
...
/*!50001 CREATE TABLE  `vw_rbac`(
 ...
 `Permission Group` int(10) unsigned ,
