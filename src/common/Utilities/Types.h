...
namespace Azgath
{
    ...
    /*
        ...
        struct Example
        {
            using TupleArg = Azgath::find_type_if_t<Azgath::is_tuple, Ts...>;

            bool HasTuple()
            {
                return !std::is_same_v<TupleArg, Azgath::find_type_end>;
            }
        };
        ...
        example2.HasTuple() == false; // TupleArg is Azgath::find_type_end
    */
    template<template<typename...> typename Check, typename... Ts>
