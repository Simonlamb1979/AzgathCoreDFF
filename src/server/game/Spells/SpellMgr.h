...
struct TC_GAME_API SpellArea
{
    ...
    Azgath::RaceMask<uint64> raceMask;                     // can be applied only to races
...
class TC_GAME_API SpellMgr
{
    ...
    public:
        ...
        Azgath::IteratorPair<SpellRequiredMap::const_iterator> GetSpellsRequiredForSpellBounds(uint32 spell_id) const;
