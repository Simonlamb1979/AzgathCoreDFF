...
namespace
{
    struct ObjectGuidInfo
    {
        ...
        std::string FormatUniq(char const* typeName, ObjectGuid guid)
        {
            ...
            return Azgath::StringFormat("%s-%s", typeName, uniqNames[id]);
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%08llX", typeName, guid.GetRealmId(), guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%016llX", typeName, guid.GetRealmId(), uint32(guid.GetRawValue(1) >> 18) & 0xFFFFFF, guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%u-%u-%u-%010llX", typeName, guid.GetSubType(), guid.GetRealmId(), guid.GetMapId(),
        ...
        {
            return Azgath::StringFormat("%s-%u-%016llX", typeName, uint32(guid.GetRawValue(1) >> 38) & 0xFFFFF, guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%u", typeName, guid.GetRealmId(), uint32(guid.GetRawValue(1) >> 26) & 0xFFFFFF, uint32(guid.GetRawValue(0)));
        }
        ...
        std::string FormatChatChannel(char const* typeName, ObjectGuid guid)
        {
            ...
            return Azgath::StringFormat("%s-%u-%u-%u-%u-%u-%08llX", typeName, guid.GetRealmId(), builtIn, trade, zoneId, factionGroupMask, guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%llu-%012llX", typeName, guid.GetRawValue(1) & 0x3FFFFFFFFFFFFFF, guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%012llX", typeName, guid.GetRealmId(), guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%08llX", typeName, guid.GetRealmId(), uint32(guid.GetRawValue(1) >> 33) & 0x1FF, guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%u-%012llX", typeName, guid.GetRealmId(), uint32(guid.GetRawValue(1) >> 37) & 0x1F,
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%u-%u-%u-%u-%06llX", typeName, uint32(guid.GetRawValue(1) >> 54) & 0xF, uint32(guid.GetRawValue(1) >> 50) & 0xF,
        ...
        {
            return Azgath::StringFormat("%s-%u-%06llX", typeName, uint32(guid.GetRawValue(1) >> 54) & 0xF, guid.GetRawValue(0));
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%012llX", typeName, guid.GetRealmId(), uint32(guid.GetRawValue(1) >> 10) & 0xFFFFFFFF, guid.GetRawValue(0));
        }
        ...
        std::string FormatClubFinder(char const* typeName, ObjectGuid guid)
        {
            ...
            if (type == 1) // guild
                return Azgath::StringFormat("%s-%u-%u-%u-%llu", typeName, type, clubFinderId, guid.GetRealmId(), guid.GetRawValue(0) /*guildId*/);

            return Azgath::StringFormat("%s-%u-%u-%016llX", typeName, type, clubFinderId, guid.GetRawValue(0) /*clubId*/);
        }
        ...
        {
            return Azgath::StringFormat("%s-%u-%u-%u-%010llX", typeName, guid.GetMapId(), uint32(guid.GetRawValue(0) >> 40) & 0xFFFFFF, guid.GetCounter());
        }
        ...
        {
            return Azgath::StringFormat("%s-%X-%u-%u-%u", typeName, uint32((guid.GetRawValue(1) >> 10) & 0xFFFFFFFF), uint32(guid.GetRawValue(1) & 0x1FF),
...
{
    return Azgath::StringFormat("0x%016llX%016llX", _data[1], _data[0]);
}
...
std::size_t ObjectGuid::GetHash() const
{
    ...
    Azgath::hash_combine(hashVal, _data[0]);
    Azgath::hash_combine(hashVal, _data[1]);
    return hashVal;
}
