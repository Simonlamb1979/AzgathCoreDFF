                ...
                if (locale < TOTAL_LOCALES)
                {
                    ...
                    switch (mapInfo->InstanceType)
                    {
                        ...
                        case MAP_ARENA:
                            ...
                            break;
                        case MAP_SCENARIO:
                            ss << handler->GetAzgathString(LANG_SCENARIO);
                            break;
                    }
        ...
        do
        {
            ...
            if (result2)
            {
                ...
                do
                {
                    ...
                    handler->PSendSysMessage(LANG_LOOKUP_PLAYER_CHARACTER, name.c_str(), guid.ToString().c_str(), online ? handler->GetAzgathString(LANG_ONLINE) : "");
                    ++counter;
                }
