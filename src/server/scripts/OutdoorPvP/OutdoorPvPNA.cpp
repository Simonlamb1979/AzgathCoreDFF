...
uint32 OPvPCapturePointNA::GetAliveGuardsCount() const
{
    ...
    Azgath::ObjectEntryAndPrivateOwnerIfExistsCheck check(ObjectGuid::Empty, GetControllingFaction() == HORDE ? 18192 : 18256);
    Azgath::WorldObjectListSearcher<Azgath::ObjectEntryAndPrivateOwnerIfExistsCheck> searcher(nullptr, guards, check, GRID_MAP_TYPE_MASK_CREATURE);
